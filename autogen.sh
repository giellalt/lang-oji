...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_oji to login script."
...
# the current dir:
if   test x${GTLANG_oji} = x ; then
	echo "WARNING: The variable \${GTLANG_oji} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_oji} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_oji} has the value:"
	echo "  ${GTLANG_oji}"
